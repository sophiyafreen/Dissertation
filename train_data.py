# -*- coding: utf-8 -*-
"""
Created on Thu Mar 17 12:20:59 2022

@author: okokp
"""

# USAGE
# python train_data.py --dataset datavalue --model model/activity.model --label-bin model/lb.pickle --epochs 80
...
LABELS = set(["BEAR","CHEETAH", "DEER", "GIRAFFE", "HIPPOPOTAMUS", "KANGAROO", "LION", "TIGER"])
...
lb = ["BEAR","CHEETAH", "DEER", "GIRAFFE", "HIPPOPOTAMUS", "KANGAROO", "LION", "TIGER"] #Thunderstorm, Building_Collapse
